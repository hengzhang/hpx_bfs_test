#if !defined(BFS_LOCALITIES_HPP)
#define BFS_LOCALITIES_HPP
...
HPX_REGISTER_ACTION_DECLARATION(bfs_localities::server::point::traverse_action, point_traverse_action);

HPX_REGISTER_ACTION_DECLARATION(bfs_localities::server::point::init_action, point_init_action);
